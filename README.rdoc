...
This project is designed to create a Rails plugin that provides a framework for registering easter eggs with applications.  
This particular repo contains a wrapping Rails application to facilitate testing during the track.  The plugin itself will 
be collected under a separate repo when it is ready for distribution.
...
If you are a MemBrain collaborator, clone the project with the private url:
	...
	prompt$ git clone git@github.com:membrain/T003_easter-egg.git
	prompt$ cd T003_easter-egg
...
To start the web server included with Ruby on Rails, open a terminal and enter the following commands:
	...
	prompt$ cd /path/to/your/parent-dir/T003_easter-egg
